...
const toolCategories: ToolCategory[] = [
  {
    ...
    tools: [
      ...
      { icon: Mountain, label: "AI场景海报设计", description: "用于制作品牌的场景展示海报", href: "/tools/ai-scene-poster", image: "placeholder" },
      { icon: Award, label: "AI品牌海报设计", description: "用于制作品牌海报", href: "/tools/ai-brand-poster", image: "placeholder" },
      { icon: CalendarDays, label: "AI活动海报设计", description: "用于制作活动宣传海报", href: "/tools/ai-event-poster", image: "placeholder" },
